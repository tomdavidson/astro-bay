...
import type { SynonymGroup, TaxonomyEdge, TaxonomyFragment } from '../types.ts'

export const slugArb = fc.array(
...
export const edgeArb: fc.Arbitrary<TaxonomyEdge> = fc.record({
  ...
  source: fc.option(fc.constantFrom('derived' as const, 'curated' as const, 'external' as const), {
    nil: undefined,
  }),
})
